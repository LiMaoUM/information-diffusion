...
void compute_z_scores(const thrust::host_vector<unsigned int>& real_counts, const std::vector<std::vector<unsigned int>>& null_counts, const std::string& output_zscores_file) {
    std::vector<double> null_means(13, 0), null_stds(13, 0);
...
__global__ void classify_subtrees(int *adj_offset, int *adj_list, int *edge_types, int num_nodes,  unsigned int *counts) {
    ...
    for (int i = start_idx; i < end_idx; i++) {
        ...
        for (int j = i + 1; j < end_idx; j++) {
            ...
            else if (edge1_type == 1 && edge2_type == 1) motif_type_star = 3;
            else if (edge1_type == 1 && edge2_type == 2) motif_type_star = 4;
            else if (edge1_type == 2 && edge2_type == 1) motif_type_star = 4;
            else if (edge1_type == 2 && edge2_type == 2) motif_type_star = 5;
        ...
        for (int j = start_b; j < end_b; j++) {
            ...
            if (edge1_type == 0 && edge2_type == 0) motif_type_chain = 6;
            else if (edge1_type == 1 && edge2_type == 0) motif_type_chain = 7;
            else if (edge1_type == 1 && edge2_type == 1) motif_type_chain = 8;
            else if (edge1_type == 1 && edge2_type == 2) motif_type_chain = 9;
            else if (edge1_type == 2 && edge2_type == 0) motif_type_chain = 10;
            else if (edge1_type == 2 && edge2_type == 1) motif_type_chain = 11;
            else if (edge1_type == 2 && edge2_type == 2) motif_type_chain = 12;
...
int main(int argc, char* argv[]) {
    ...
    thrust::device_vector<unsigned int> d_real_counts(13, 0);
    ...
    std::vector<std::vector<unsigned int>> null_motif_counts(NUM_NULL_MODELS, std::vector<unsigned int>(13, 0));
    ...
    for (int i = 0; i < NUM_NULL_MODELS; i++) {
        ...
        thrust::device_vector<unsigned int> d_counts(13, 0);
