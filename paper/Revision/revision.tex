...
\toprule
Type & Platform & Cascades & Posts & Size 1 & $>$50 posts \\
\midrule
...
\caption{\rev{Cascade counts and sizes. ``Size 1'' is the share of cascades consisting of a single post; the full size distribution is in Appendix Table~\ref{tab:descriptives}.}}
...
Motif results highlight the combined role of interactional structure and user composition. On Truth Social, \rev{left-leaning users are a small minority of the users we observe}, yet appear disproportionately in Left$\leftrightarrow$Right bounce-back motifs: these are strongly overrepresented relative to the null model while remaining rare in absolute terms. \rev{This is why the model needs composition as well as alignment: how often exchanges cross ideological lines also depends on how many users of each ideology take part, which is what composition measures.}
