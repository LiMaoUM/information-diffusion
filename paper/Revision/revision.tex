...
\rev{Deleting follow edges at random at rates from 5\% to 30\% to simulate such edges moves the breadth interaction only from $0.031$ to $0.005$ and the depth interaction from $0.004$ to $0.013$, both far below the reply values. This error need not be symmetric across platforms, since the two follow networks were collected at different times relative to the posting window.}
